...
_Rdz 2,15 - Wziął więc Pan Bóg człowieka i dał mu odpocząć w ogrodzie Eden, aby go uprawiał i strzegł._

Pierwsze powołanie do pracy, jeszcze przed grzechem.
Praca nie jest efektem grzechu pierworodnego, ale jest czymś dobrym. Zamysłem Bożym.

_KKK 2427 Praca ludzka jest bezpośrednim działaniem osób stworzonych na obraz Boży i powołanych do przedłużania – wraz z innymi – dzieła stworzenia, czyniąc sobie ziemię poddaną (Por. Rdz 1, 28; Sobór Watykański II, konst. Gaudium et spes, 34; Jan Paweł II, enc. Centesimus annus, 31)._

To realizacja naszego podobieństwa do Boga. Kiedy pracujesz jesteś podobny do Boga. 
Praca jest przedłużeniem dzieła stworzenia. Wow! Bóg stworzył świat, ale na tym świecie nie było jeszcze wieży
Eiffla? Nie było jeszcze samochodów, samolotów. Bóg dał ramy, jak płótno malarza i my to wypełniamy. 
np. Budowa twojego domu to dodajesz coś do świata stworzonego przez Boga.
...
_2 Tes 3,10 Kto nie chce pracować, niech też nie je._

Nie chce. Nie że nie może czy jest chory. tylko ten który nie chce.
...
## Pytania 
1. Czy pracowałbym inaczej, gdyby na miejscu mojego szefa był Jezus?
2. W jakiej roli lepiej wykonywałbym swoją pracę - jako prezes, kierownik, sprzedawca, czy pracownik fizyczny?
3. Czy nie biorę na siebie zbyt wielu obowiązków?


# Przedsiębiorczość - Drugi temat


Przedsiębiorczość jako współtworzenie (Przypowieść o Talentach - Mt 25): Przedsiębiorca to ktoś, kto bierze 5 talentów i robi z nich 10. Bóg jest inwestorem, który daje kapitał (inteligencję, zdrowie, pomysły) i oczekuje zwrotu. Zakopanie talentu ze strachu to anty-przedsiębiorczość, za którą Pan w przypowieści surowo karze.

Rozwiązywanie realnych problemów:
Biznes chrześcijanina nie istnieje tylko po to, by generować zysk. Zysk jest jak tlen – potrzebny do życia, ale nie żyje się po to, by oddychać. Prawdziwym celem jest służba. Narzędzia technologiczne, które np. automatyzują żmudne procesy, zliczają dane i analizują wideo, realnie zdejmują z ludzi ciężar nudnej pracy, uwalniając ich czas na rzeczy ważniejsze.

Praca zespołowa i odpowiedzialność:
Przedsiębiorczość to budowanie ekosystemu. W małych, dynamicznych zespołach widać jak na dłoni, że brak komunikacji czy silosowość niszczą projekt. Transparentność działań (np. wspólny wgląd w relacje biznesowe czy sprzedażowe) buduje zaufanie. To samo dotyczy relacji z klientem. Chrześcijańska przedsiębiorczość to dotrzymywanie słowa – pilnowanie terminów ustaleń to nie tylko wymóg systemowy, ale kwestia naszej wiarygodności. Brak kontaktu z klientem, któremu coś obiecaliśmy (np. dłuższy niż 14 dni), to sygnał, że lekceważymy relację.
...
Prawa do sprawiedliwej zapłaty (która jest podstawowym sprawdzianem sprawiedliwości ustroju społeczno-gospodarczego).

Na podstawie kard Ryśia
https://www.youtube.com/watch?v=PESGyuWXPz0


Kreatywność jako największy potencjał: Kompendium podkreśla wagę inicjatywy gospodarczej. Oczekiwaniem wobec człowieka pracy jest kreatywność. Największym "kapitałem" i potencjałem w firmie jest sam człowiek [17:24].

Profit a Godność Człowieka: Te dwie wartości nigdy nie mogą stać do siebie w opozycji. Nie można akceptować sytuacji, w której bilanse finansowe firmy są wzorowe, ale godność człowieka (pracownika) jest w niej deptana [20:42]. Godziwa płaca nie zależy wyłącznie od tego, że "strony się dogadały" – musi spełniać kryteria moralne [14:09].
